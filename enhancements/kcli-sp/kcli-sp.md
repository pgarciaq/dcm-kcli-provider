...
- 2026-04-22: E2E testing on Apollo hypervisor. Deployed full DCM stack,
  validated dual registration, VM/cluster lifecycle, NATS CloudEvents,
  and error handling against live kweb (kcli v99.0). Fixed kweb conflict
  detection for HTTP 200 failure responses. Documented SPM generic
  resource protocol gap and added example catalog/policy configs.
